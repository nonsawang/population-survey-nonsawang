...
export function ScreeningReview(){
 ...
 return <section className="card p-3 mb-4"><h5>ตรวจอนุมัติผลคัดกรอง</h5><p>FIT ตรวจรหัสแล็บและค่าบริการแล้ว เปิดตัวอย่างและเตรียมรายการได้หลังอนุมัติ ส่วน HBV/HCV, HPV และพัฒนาการเด็กยังต้องตรวจ mapping ให้ครบ การเตรียมรายการยังไม่สร้าง visit</p><State {...q}/>{notice&&<p role="status">{notice}</p>}{q.data?.length===0&&<p>ยังไม่มีรายการคัดกรองที่เข้าเงื่อนไข</p>}
