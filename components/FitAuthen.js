...
export default function FitAuthen({vn,checks,verifiedAt}){
 ...
 return <section className="border rounded bg-light p-3 my-3" aria-label="จัดการ Authen">
  ...
  <div className="d-flex flex-wrap gap-2 mb-2">
   <a className="btn btn-primary" href="/hosxp-review#authen-report">นำเข้ารายงานเพื่อจับคู่ Authen</a>
   ...
   <a className="btn btn-outline-primary" href="https://authenservice.nhso.go.th/authencode/claimcode/create/own" target="_blank" rel="noopener noreferrer">เปิด New Authen</a>
  </div>
